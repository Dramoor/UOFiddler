...
namespace UoFiddler.Controls.Classes
{
    ...
    public static class ServUOScriptGenerator
    {
        ...
        public static string GenerateItemScript(int itemId, string itemName, string outputDirectory, int itemWeight = 1, bool useHue = false, int previewHue = 0, bool isStackable = false, bool isArtifact = false, string prefix = "None", string lootType = "Regular", int flippableId = 0, string scriptName = null, bool isReadOnly = false)
        {
            ...
            try
            {
                ...
                string scriptContent = GenerateScriptContent(className, itemId, itemName, itemWeight, useHue, previewHue, isStackable, isArtifact, prefix, lootType, flippableId, isReadOnly);
        ...
        /// </summary>
        private static string GenerateScriptContent(string className, int itemId, string itemName, int itemWeight, bool useHue, int previewHue, bool isStackable, bool isArtifact, string prefix = "None", string lootType = "Regular", int flippableId = 0, bool isReadOnly = false)
        {
...
{{
    ...
    {{
{artifactProperty}{defaultNameProperty}{defaultConstructor}{secondaryConstructor}
